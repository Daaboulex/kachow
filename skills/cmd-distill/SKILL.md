---
name: cmd-distill
description: "Lossless document compression with round-trip validation. Preserves every fact, decision, and constraint while removing prose overhead. Usage: /distill <path> [--target-ratio 0.3] [--no-validate] [--chunk-size 500]"
---
