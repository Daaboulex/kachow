---
name: cmd-review-adversarial
description: "Launch an adversarial code review that MUST find a minimum number of issues. Zero findings triggers re-analysis. Prevents rubber-stamping. Usage: /review-adversarial [path] [--min N] [--scope files|phase|pr]"
---
