---
name: cmd-shard-doc
description: "Split a large markdown file into a directory with index + sections. Consumers transparently discover either format. Usage: /shard-doc <path> [--threshold 500] [--reassemble]"
---
