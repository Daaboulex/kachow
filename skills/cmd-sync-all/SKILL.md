---
description: One-command sync of ALL context artifacts across all 5 tools (Claude, Gemini, Codex, Crush, OpenCode). Run after any context system change to ensure everything is in sync.
name: cmd-sync-all
---
